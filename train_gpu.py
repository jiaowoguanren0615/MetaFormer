...
from util.optimizer import AdamAtan2, MARS
...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'MetaFormer training and evaluation script', add_help=False)
    ...
    parser.add_argument('--model', default='caformer_m36', type=str, metavar='MODEL',
                        choices=['identityformer_m36', 'identityformer_m48', 'identityformer_s12', 'identityformer_s24',
                                 'identityformer_s36', 'randformer_s12', 'randformer_s24', 'randformer_s36',
                                 'randformer_m36', 'randformer_m48',
                                 'poolformerv2_s12', 'poolformerv2_s24', 'poolformerv2_s36', 'poolformerv2_m36',
                                 'poolformerv2_m48', 'convformer_s18',
                                 'convformer_s18_in21k', 'convformer_m36_in21k', 'convformer_m36',
                                 'convformer_b36_in21k', 'convformer_s36_in21k',
                                 'convformer_b36', 'convformer_s36', 'convformer_b36_384', 'convformer_m36_384',
                                 'convformer_s18_384', 'convformer_s36_384',
                                 'convformer_b36_384_in21ft1k', 'convformer_m36_384_in21ft1k',
                                 'convformer_s18_384_in21ft1k', 'convformer_s36_384_in21ft1k',
                                 'convformer_s18_in21ft1k', 'convformer_s36_in21ft1k', 'convformer_b36_in21ft1k',
                                 'convformer_m36_in21ft1k', 'caformer_m36_384',
                                 'caformer_b36', 'caformer_b36_384', 'caformer_m36', 'caformer_s18', 'caformer_s36',
                                 'caformer_s18_384', 'caformer_s36_384',
                                 'caformer_b36_in21k', 'caformer_s18_in21k', 'caformer_s36_in21k',
                                 'caformer_m364_in21k', 'caformer_s18_384_in21ft1k',
                                 'caformer_m36_384_in21ft1k', 'caformer_s36_384_in21ft1k', 'caformer_b36_384_in21ft1k',
                                 'caformer_s18_in21ft1k',
    ...
    # Finetuning params
    parser.add_argument('--finetune', default='./models/caformer_m36.pth',
...
def main(args):
    ...
    args.input_size = default_cfgs[args.model]['input_size'][-1]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'MetaFormer training and evaluation script', parents=[get_args_parser()])
